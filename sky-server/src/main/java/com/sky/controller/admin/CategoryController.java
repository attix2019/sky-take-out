...
public class CategoryController {
    ...
    @GetMapping("/page")
    @ApiOperation("分类分页查询")
    public Result<PageResult> findCategories(CategoryPageQueryDTO categoryPageQueryDTO){
        log.info("分页查询：{}", categoryPageQueryDTO);
        PageResult pageResult = categoryService.findCategories(categoryPageQueryDTO);
